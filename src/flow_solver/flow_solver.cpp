        ...
        while(ode_solver->current_time < final_time)
        {
            ...
            if(flow_solver_param.output_restart_files == true) {
                ...
                if(flow_solver_param.output_restart_files_every_dt_time_intervals > 0.0) {
                    ...
                    if (is_output_time) {
                        const double file_number = round(current_desired_time_for_output_restart_files_every_dt_time_intervals / flow_solver_param.output_restart_files_every_dt_time_intervals);
