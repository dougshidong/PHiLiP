...
EulerNACA0012<dim,nspecies,nstate>::EulerNACA0012(const Parameters::AllParameters *const parameters_input,
...
template<int dim, int nspecies, int nstate>
int EulerNACA0012<dim,nspecies,nstate>
::run_test () const
{
    ...
    template class EulerNACA0012 <PHILIP_DIM, PHILIP_SPECIES,PHILIP_DIM+2>;
#endif
