...
template <int dim, int nstate, typename real>
std::array<real,nstate> MultiSpeciesCaloricallyPerfect<dim, nstate, real>
::compute_entropy_variables (
    const std::array<real,nstate> &conservative_soln) const
{
    std::cout<<"Entropy variables for MultiSpeciesCaloricallyPerfect hasn't been done yet."<<std::endl;
    std::abort();
...
template <int dim, int nstate, typename real>
real MultiSpeciesCaloricallyPerfect<dim,nstate,real>
    ...
    const dealii::types::global_dof_index /*cell_index*/) const
{
    ...
    // No dissipative flux (i.e. viscous terms) for MultiSpeciesCaloricallyPerfect
...
// bool MultiSpeciesCaloricallyPerfect<dim,nstate,real>::check_positive_quantity(real2 &qty, const std::string qty_name) const {
...
template <int dim, int nstate, typename real>
void MultiSpeciesCaloricallyPerfect<dim,nstate,real>
...
template <int dim, int nstate, typename real>
template<typename real2>
inline real2 MultiSpeciesCaloricallyPerfect<dim,nstate,real>
...
/// f_M2: velocities
template <int dim, int nstate, typename real>
inline dealii::Tensor<1,dim,real> MultiSpeciesCaloricallyPerfect<dim,nstate,real>
...
template <int dim, int nstate, typename real>
std::array<real,nstate-dim-1> MultiSpeciesCaloricallyPerfect<dim,nstate,real>
...
template <int dim, int nstate, typename real>
dealii::Vector<double> MultiSpeciesCaloricallyPerfect<dim,nstate,real>::post_compute_derived_quantities_vector (
...
template <int dim, int nstate, typename real>
std::vector<dealii::DataComponentInterpretation::DataComponentInterpretation> MultiSpeciesCaloricallyPerfect<dim,nstate,real>
...
template <int dim, int nstate, typename real>
std::vector<std::string> MultiSpeciesCaloricallyPerfect<dim,nstate,real>
...
template <int dim, int nstate, typename real>
dealii::UpdateFlags MultiSpeciesCaloricallyPerfect<dim,nstate,real>
