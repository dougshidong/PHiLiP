...
void DGStrongLES<dim,nstate,real,MeshType>::update_model_variables()
{
    ...
    // if(this->do_compute_mean_strain_rate_tensor) update_cellwise_mean_quantities();
}
...
//     int overintegrate = 10; // TO DO: Reduce this to save computational cost --> set to zero
...
//             this->cellwise_mean_strain_rate_tensor_magnitude[cell_index] = this->pde_model_les_double->navier_stokes_physics->get_tensor_magnitude(cell_mean_strain_rate_tensor);
//         }
//     }
