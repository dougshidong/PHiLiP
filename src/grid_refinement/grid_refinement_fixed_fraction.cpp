...
// Define a macro to instantiate GridRefinement_FixedFraction for a specific index
#define INSTANTIATE_DISTRIBUTED(r, data, index) \
    template class GridRefinement_FixedFraction <PHILIP_DIM, index, double, dealii::parallel::distributed::Triangulation<PHILIP_DIM>>;
...
#define INSTANTIATE_SHARED(r, data, index) \
    template class GridRefinement_FixedFraction <PHILIP_DIM, index, double, dealii::parallel::shared::Triangulation<PHILIP_DIM>>;
BOOST_PP_SEQ_FOR_EACH(INSTANTIATE_SHARED, _, POSSIBLE_NSTATE)

#define INSTANTIATE_TRIA(r, data, index) \
    template class GridRefinement_FixedFraction <PHILIP_DIM, index, double, dealii::Triangulation<PHILIP_DIM>>;
