...
class InviscidTaylorGreen : public TestsBase
{
public:
    /// Constructor.
    /** Simply calls the TestsBase constructor to set its parameters = parameters_input
     * */
    explicit InviscidTaylorGreen(const Parameters::AllParameters *const parameters_input);
...
private:
    ...
    */
     ...
     */
   // double compute_change_in_entropy(std::shared_ptr < DGBase<dim, nspecies, double> > &dg, unsigned int poly_degree) const;
