...
// dfad_example (simplified dfad_dfad_example)
//
//  usage:
//     dfad_example
//
//  output:
//     prints the results of computing only the first derivative a simple function //     with forward nested forward mode AD using the Sacado::Fad::DFad class
