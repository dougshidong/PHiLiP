...
{
    const double gamma[5][3] = {{0.0, 1.0, 0.0}, {0.2587771979725733308135192812685323706, 0.5528354909301389892439698870483746541, 0.0}, {-0.1324380360140723382965420909764953437, 0.6731871608203061824849561782794643600, 0.0}, {0.05056033948190826045833606441415585735, 0.2803103963297672407841316576323901761, 0.2752563273304676380891217287572780582}, {0.5670532000739313812633197158607642990, 0.5521525447020610386070346724931300367, -0.8950526174674033822276061734289327568}};
    for (int i = 0; i < 5; i++){
        for (int j = 0; j < 3; j++){
            this->butcher_tableau_gamma[i][j] = gamma[i][j];
        }
...
{
    const double beta[5] = {0.11479359710235412, 0.089334428531133159, 0.43558710250086169, 0.24735761882014512, 0.058819144221557401};
    this->butcher_tableau_beta.fill(beta);
}
