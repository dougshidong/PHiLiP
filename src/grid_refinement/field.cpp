...
typename Element<dim,nspecies,real>::ChordList Element<dim,nspecies,real>::get_chord_list(
	const typename Element<dim,nspecies,real>::VertexList& vertices)
{
    ...
    */
	...
	Element<dim,nspecies,real>::ChordList chord_list;
...
template <int dim, int nspecies, typename real>
real& ElementIsotropic<dim,nspecies,real>::scale()
{
	return m_scale;
}

template <int dim, int nspecies, typename real>
void ElementIsotropic<dim,nspecies,real>::set_scale(
	const real val)
{
	m_scale = val;
}
...
template <int dim, int nspecies, typename real>
real ElementIsotropic<dim,nspecies,real>::get_scale() const 
{
	return m_scale;
}

template <int dim, int nspecies, typename real>
void ElementIsotropic<dim,nspecies,real>::set_anisotropic_ratio(
...
template <int dim, int nspecies, typename real>
std::array<real,dim> ElementIsotropic<dim,nspecies,real>::get_anisotropic_ratio()
{
...
template <int dim, int nspecies, typename real>
real ElementIsotropic<dim,nspecies,real>::get_anisotropic_ratio(
...
template <int dim, int nspecies, typename real>
void ElementIsotropic<dim,nspecies,real>::set_unit_axis(
...
template <int dim, int nspecies, typename real>
std::array<dealii::Tensor<1,dim,real>,dim> ElementIsotropic<dim,nspecies,real>::get_unit_axis()
{
...
template <int dim, int nspecies, typename real>
dealii::Tensor<1,dim,real> ElementIsotropic<dim,nspecies,real>::get_unit_axis(
	const unsigned int j)
{
...
template <int dim, int nspecies, typename real>
void ElementIsotropic<dim,nspecies,real>::set_axis(
...
template <int dim, int nspecies, typename real>
std::array<dealii::Tensor<1,dim,real>,dim> ElementIsotropic<dim,nspecies,real>::get_axis()
{
...
template <int dim, int nspecies, typename real>
dealii::Tensor<1,dim,real> ElementIsotropic<dim,nspecies,real>::get_axis(
	const unsigned int j)
{
...
template <int dim, int nspecies, typename real>
dealii::Tensor<2,dim,real> ElementIsotropic<dim,nspecies,real>::get_metric()
{
...
template <int dim, int nspecies, typename real>
dealii::Tensor<2,dim,real> ElementIsotropic<dim,nspecies,real>::get_inverse_metric()
{
...
template <int dim, int nspecies, typename real>
void ElementIsotropic<dim,nspecies,real>::set_cell_internal(
	const typename Element<dim,nspecies,real>::VertexList& vertices)
{
	// to be consistent with anisotropic case using the average from chord lengths
	typename Element<dim,nspecies,real>::ChordList chord_list = Element<dim,nspecies,real>::get_chord_list(vertices);
...
template <int dim, int nspecies, typename real>
void ElementIsotropic<dim,nspecies,real>::set_anisotropy(
...
template <int dim, int nspecies, typename real>
void ElementIsotropic<dim,nspecies,real>::apply_anisotropic_limit(
...
template <int dim, int nspecies, typename real>
ElementAnisotropic<dim,nspecies,real>::ElementAnisotropic()
{
...
template <int dim, int nspecies, typename real>
real& ElementAnisotropic<dim,nspecies,real>::scale()
{
	return m_scale;
}

template <int dim, int nspecies, typename real>
void ElementAnisotropic<dim,nspecies,real>::set_scale(
	const real         val)
{
	m_scale = val;
}
...
template <int dim, int nspecies, typename real>
real ElementAnisotropic<dim,nspecies,real>::get_scale() const
{
	return m_scale;
}

template <int dim, int nspecies, typename real>
void ElementAnisotropic<dim,nspecies,real>::set_anisotropic_ratio(
	const std::array<real,dim>& ratio)
{
...
template <int dim, int nspecies, typename real>
real ElementAnisotropic<dim,nspecies,real>::get_anisotropic_ratio(
	const unsigned int j)
{
...
template <int dim, int nspecies, typename real>
std::array<real,dim> ElementAnisotropic<dim,nspecies,real>::get_anisotropic_ratio()
{
	return m_anisotropic_ratio;
}

template <int dim, int nspecies, typename real>
void ElementAnisotropic<dim,nspecies,real>::set_unit_axis(
	const std::array<dealii::Tensor<1,dim,real>,dim>& unit_axis)
{
...
template <int dim, int nspecies, typename real>
std::array<dealii::Tensor<1,dim,real>,dim> ElementAnisotropic<dim,nspecies,real>::get_unit_axis()
{
	return m_unit_axis;
}

template <int dim, int nspecies, typename real>
dealii::Tensor<1,dim,real> ElementAnisotropic<dim,nspecies,real>::get_unit_axis(
	unsigned int j)
{
...
template <int dim, int nspecies, typename real>
void ElementAnisotropic<dim,nspecies,real>::set_axis(
	const std::array<dealii::Tensor<1,dim,real>,dim>& axis)
{
...
template <int dim, int nspecies, typename real>
dealii::Tensor<1,dim,real> ElementAnisotropic<dim,nspecies,real>::get_axis(
	unsigned int j)
{
...
template <int dim, int nspecies, typename real>
std::array<dealii::Tensor<1,dim,real>,dim> ElementAnisotropic<dim,nspecies,real>::get_axis()
{
	std::array<dealii::Tensor<1,dim,real>,dim> axis;
...
template <int dim, int nspecies, typename real>
dealii::Tensor<2,dim,real> ElementAnisotropic<dim,nspecies,real>::get_metric()
{
	dealii::Tensor<2,dim,real> M;
...
template <int dim, int nspecies, typename real>
dealii::Tensor<2,dim,real> ElementAnisotropic<dim,nspecies,real>::get_inverse_metric()
{
	// building the rotation matrix
	dealii::Tensor<2,dim,real> R;
	for(unsigned int i = 0; i < dim; ++i)
...
template <int dim, int nspecies, typename real>
void ElementAnisotropic<dim,nspecies,real>::clear()
{
	// define no element
	m_scale = 0.0;
...
template <int dim, int nspecies, typename real>
void ElementAnisotropic<dim,nspecies,real>::correct_element()
{
	correct_unit_axis();
...
template <int dim, int nspecies, typename real>
void ElementAnisotropic<dim,nspecies,real>::correct_unit_axis()
{
	for(unsigned int j = 0; j < dim; ++j){
...
template <int dim, int nspecies, typename real>
void ElementAnisotropic<dim,nspecies,real>::correct_anisotropic_ratio()
{
...
template <int dim, int nspecies, typename real>
void ElementAnisotropic<dim,nspecies,real>::sort_anisotropic_ratio()
{
...
template <int dim, int nspecies, typename real>
void ElementAnisotropic<dim,nspecies,real>::set_cell_internal(
	const typename Element<dim,nspecies,real>::VertexList& vertices)
{
	// to be consistent with anisotropic case using the average from chord lengths
	typename Element<dim,nspecies,real>::ChordList chord_list = Element<dim,nspecies,real>::get_chord_list(vertices);
...
template <int dim, int nspecies, typename real>
void ElementAnisotropic<dim,nspecies,real>::set_anisotropy(
	const std::array<real,dim>&                       derivative_value,
	const std::array<dealii::Tensor<1,dim,real>,dim>& derivative_direction,
	const unsigned int                                order)
{
...
template <int dim, int nspecies, typename real>
void ElementAnisotropic<dim,nspecies,real>::apply_anisotropic_limit(
	const real anisotropic_ratio_min,
	const real anisotropic_ratio_max)
{
...
template <int dim, int nspecies, typename real>
void Field<dim,nspecies,real>::set_scale_vector_dealii(
...
template <int dim, int nspecies, typename real>
void Field<dim,nspecies,real>::set_scale_vector(
...
template <int dim, int nspecies, typename real>
dealii::Vector<real> Field<dim,nspecies,real>::get_scale_vector_dealii() const
{
...
template <int dim, int nspecies, typename real>
std::vector<real> Field<dim,nspecies,real>::get_scale_vector() const
{
...
template <int dim, int nspecies, typename real>
dealii::Vector<real> Field<dim,nspecies,real>::get_max_anisotropic_ratio_vector_dealii()
{
	dealii::Vector<real> vec(this->size());
...
template <int dim, int nspecies, typename real>
void Field<dim,nspecies,real>::set_axis_vector(
...
template <int dim, int nspecies, typename real>
std::vector<std::array<dealii::Tensor<1,dim,real>,dim>> Field<dim,nspecies,real>::get_axis_vector()
{
...
template <int dim, int nspecies, typename real>
std::vector<dealii::Tensor<1,dim,real>> Field<dim,nspecies,real>::get_axis_vector(
	const unsigned int j)
{
...
template <int dim, int nspecies, typename real>
std::vector<dealii::Tensor<2,dim,real>> Field<dim,nspecies,real>::get_metric_vector()
{
...
template <int dim, int nspecies, typename real>
std::vector<dealii::Tensor<2,dim,real>> Field<dim,nspecies,real>::get_inverse_metric_vector()
{
	std::vector<dealii::Tensor<2,dim,real>> vec(this->size());
...
template <int dim, int nspecies, typename real>
dealii::SymmetricTensor<2,dim,real> Field<dim,nspecies,real>::get_quadratic_metric(
...
template <int dim, int nspecies, typename real>
std::vector<dealii::SymmetricTensor<2,dim,real>> Field<dim,nspecies,real>::get_quadratic_metric_vector()
{
...
template <int dim, int nspecies, typename real>
dealii::SymmetricTensor<2,dim,real> Field<dim,nspecies,real>::get_inverse_quadratic_metric(
	const unsigned int index)
{
...
template <int dim, int nspecies, typename real>
std::vector<dealii::SymmetricTensor<2,dim,real>> Field<dim,nspecies,real>::get_inverse_quadratic_metric_vector()
{
	std::vector<dealii::SymmetricTensor<2,dim,real>> vec(this->size());
...
void FieldInternal<dim,nspecies,real,ElementType>::reinit(
...
template <int dim, int nspecies, typename real, typename ElementType>
unsigned int FieldInternal<dim,nspecies,real,ElementType>::size() const
{
	return field.size();
}

template <int dim, int nspecies, typename real, typename ElementType>
real& FieldInternal<dim,nspecies,real,ElementType>::scale(
	const unsigned int index)
{
...
template <int dim, int nspecies, typename real, typename ElementType>
void FieldInternal<dim,nspecies,real,ElementType>::set_scale(
	const unsigned int index,
	const real         val)
{
...
template <int dim, int nspecies, typename real, typename ElementType>
real FieldInternal<dim,nspecies,real,ElementType>::get_scale(
...
template <int dim, int nspecies, typename real, typename ElementType>
void FieldInternal<dim,nspecies,real,ElementType>::set_anisotropic_ratio(
	const unsigned int index,
	const std::array<real,dim>& ratio)
{
...
template <int dim, int nspecies, typename real, typename ElementType>
std::array<real,dim> FieldInternal<dim,nspecies,real,ElementType>::get_anisotropic_ratio(
	const unsigned int index)
{
...
template <int dim, int nspecies, typename real, typename ElementType>
real FieldInternal<dim,nspecies,real,ElementType>::get_anisotropic_ratio(
	const unsigned int index,
	const unsigned int j)
{
...
template <int dim, int nspecies, typename real, typename ElementType>
void FieldInternal<dim,nspecies,real,ElementType>::set_unit_axis(
	const unsigned int                                index,
	const std::array<dealii::Tensor<1,dim,real>,dim>& unit_axis)
{
...
template <int dim, int nspecies, typename real, typename ElementType>
std::array<dealii::Tensor<1,dim,real>,dim> FieldInternal<dim,nspecies,real,ElementType>::get_unit_axis(
	const unsigned int index)
{
...
template <int dim, int nspecies, typename real, typename ElementType>
dealii::Tensor<1,dim,real> FieldInternal<dim,nspecies,real,ElementType>::get_unit_axis(
	const unsigned int index,
	const unsigned int j)
{
...
template <int dim, int nspecies, typename real, typename ElementType>
void FieldInternal<dim,nspecies,real,ElementType>::set_axis(
	const unsigned int                                index,
	const std::array<dealii::Tensor<1,dim,real>,dim>& axis)
{
...
template <int dim, int nspecies, typename real, typename ElementType>
std::array<dealii::Tensor<1,dim,real>,dim> FieldInternal<dim,nspecies,real,ElementType>::get_axis(
	const unsigned int index)
{
...
template <int dim, int nspecies, typename real, typename ElementType>
dealii::Tensor<1,dim,real> FieldInternal<dim,nspecies,real,ElementType>::get_axis(
	const unsigned int index,
	const unsigned int j)
{
...
template <int dim, int nspecies, typename real, typename ElementType>
dealii::Tensor<2,dim,real> FieldInternal<dim,nspecies,real,ElementType>::get_metric(
	const unsigned int index)
{
...
template <int dim, int nspecies, typename real, typename ElementType>
dealii::Tensor<2,dim,real> FieldInternal<dim,nspecies,real,ElementType>::get_inverse_metric(
	const unsigned int index)
{
...
template <int dim, int nspecies, typename real, typename ElementType>
void FieldInternal<dim,nspecies,real,ElementType>::set_anisotropy(
...
template <int dim, int nspecies, typename real, typename ElementType>
void FieldInternal<dim,nspecies,real,ElementType>::apply_anisotropic_limit(
	const real anisotropic_ratio_min,
	const real anisotropic_ratio_max)
{
...
template <int dim, int nspecies, typename real, typename ElementType>
std::ostream& FieldInternal<dim,nspecies,real,ElementType>::serialize(
...
template class Field <PHILIP_DIM, PHILIP_SPECIES, double>;

// FieldIsotropic
template class FieldInternal <PHILIP_DIM, PHILIP_SPECIES, double, ElementIsotropic<PHILIP_DIM, PHILIP_SPECIES, double>>;

// FieldAnisotropic
template class FieldInternal <PHILIP_DIM, PHILIP_SPECIES, double, ElementAnisotropic<PHILIP_DIM, PHILIP_SPECIES, double>>;
