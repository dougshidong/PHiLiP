#ifndef __PDE_CONSTRAINTS_H__
#define __PDE_CONSTRAINTS_H__
...
*/
template<int dim>
class PDEConstraints : public ROL::Constraint_SimOpt<double> {
private:
...
public:
    ...
    void update_1( const ROL::Vector<double>& des_var_sim, bool flag = true, int iter = -1 ) override ;

    /// Update the control variables.
    /** Update FFD from design variables and then deforms the mesh.
     */
    void update_2( const ROL::Vector<double>& des_var_ctl, bool flag = true, int iter = -1 ) override;
