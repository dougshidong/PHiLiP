...
memory_per_node="63G" # requested memory per node; NOTE: Must correspond to ntasks_per_node; refer to https://docs.computecanada.ca/wiki/Advanced_MPI_scheduling
