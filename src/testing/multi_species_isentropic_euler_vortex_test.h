#ifndef __MULTI_SPECIES_ISENTROPIC_EULER_VORTEX_TEST_H__
#define __MULTI_SPECIES_ISENTROPIC_EULER_VORTEX_TEST_H__
...
class MultiSpeciesIsentropicEulerVortexTest: public TestsBase
{
public:
    /// Constructor. Deleted the default constructor since it should not be used
    MultiSpeciesIsentropicEulerVortexTest () = delete;
    /// Constructor.
    /** Simply calls the TestsBase constructor to set its parameters = parameters_input
     */
    MultiSpeciesIsentropicEulerVortexTest(const Parameters::AllParameters *const parameters_input,
