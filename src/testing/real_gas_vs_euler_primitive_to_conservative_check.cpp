...
RealGasVsEulerPrimitiveToConservativeCheck<dim, nspecies, nstate>::RealGasVsEulerPrimitiveToConservativeCheck(
...
template <int dim, int nspecies, int nstate>
int RealGasVsEulerPrimitiveToConservativeCheck<dim, nspecies, nstate>::run_test() const
{
...
#if PHILIP_SPECIES==1
template class RealGasVsEulerPrimitiveToConservativeCheck<PHILIP_DIM, PHILIP_SPECIES, PHILIP_DIM+2>;
#endif
} // Tests namespace
} // PHiLiP namespace