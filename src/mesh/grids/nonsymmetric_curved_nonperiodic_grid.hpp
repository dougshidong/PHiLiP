#ifndef __NONSYMMETRIC_CURVED_NONPERIODIC_GRID_H__
#define __NONSYMMETRIC_CURVED_NONPERIODIC_GRID_H__
...
class NonsymmetricCurvedNonPerGridManifold: public dealii::ChartManifold<dim,spacedim,chartdim> {
protected:
...
public:
    /// Constructor.
    NonsymmetricCurvedNonPerGridManifold()
