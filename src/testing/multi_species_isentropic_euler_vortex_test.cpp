...
MultiSpeciesIsentropicEulerVortexTest<dim,nstate>::MultiSpeciesIsentropicEulerVortexTest(
...
template<int dim, int nstate>
int MultiSpeciesIsentropicEulerVortexTest<dim,nstate>
::run_test () const
{
...
// template <int dim, int nstate>
// double MultiSpeciesIsentropicEulerVortexTest<dim,nstate>
...
// #if PHILIP_DIM==2
//     template class MultiSpeciesIsentropicEulerVortexTest <PHILIP_DIM,PHILIP_DIM+2>;
// #endif

// #if PHILIP_DIM==1
// template class MultiSpeciesIsentropicEulerVortexTest <PHILIP_DIM,PHILIP_DIM>;
template class MultiSpeciesIsentropicEulerVortexTest <PHILIP_DIM,PHILIP_DIM+2>; // euler (1-species)_
#if PHILIP_DIM==2
template class MultiSpeciesIsentropicEulerVortexTest <PHILIP_DIM,PHILIP_DIM+2+2-1>; // TO DO: N_SPECIES
#endif
// #else
// template class MultiSpeciesIsentropicEulerVortexTest <PHILIP_DIM,PHILIP_DIM+2>;
// template class MultiSpeciesIsentropicEulerVortexTest <PHILIP_DIM,PHILIP_DIM+2+2-1>; // TO DO: N_SPECIES
