...
public:
    /// Constructor
    TestLocationBase(const RowVectorXd& parameter, std::unique_ptr<ROMSolution < dim, nspecies, nstate>> rom_solution);
    ...
    /// ROM solution
    std::unique_ptr<ROMSolution<dim, nspecies, nstate>> rom_solution;
