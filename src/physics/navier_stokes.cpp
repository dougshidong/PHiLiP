...
// -- get_velocity_component_parallel_to_wall_from_solution_and_normal_vector
template double     NavierStokes_ChannelFlowConstantSourceTerm_WallModel < PHILIP_DIM, PHILIP_DIM+2, double    >::get_velocity_component_parallel_to_wall_from_solution_and_normal_vector(const std::array<double    ,PHILIP_DIM+2> &conservative_soln, const dealii::Tensor<1,PHILIP_DIM,double    > &normal_vector) const;
template FadType    NavierStokes_ChannelFlowConstantSourceTerm_WallModel < PHILIP_DIM, PHILIP_DIM+2, FadType   >::get_velocity_component_parallel_to_wall_from_solution_and_normal_vector(const std::array<FadType   ,PHILIP_DIM+2> &conservative_soln, const dealii::Tensor<1,PHILIP_DIM,FadType   > &normal_vector) const;
template RadType    NavierStokes_ChannelFlowConstantSourceTerm_WallModel < PHILIP_DIM, PHILIP_DIM+2, RadType   >::get_velocity_component_parallel_to_wall_from_solution_and_normal_vector(const std::array<RadType   ,PHILIP_DIM+2> &conservative_soln, const dealii::Tensor<1,PHILIP_DIM,RadType   > &normal_vector) const;
template FadFadType NavierStokes_ChannelFlowConstantSourceTerm_WallModel < PHILIP_DIM, PHILIP_DIM+2, FadFadType>::get_velocity_component_parallel_to_wall_from_solution_and_normal_vector(const std::array<FadFadType,PHILIP_DIM+2> &conservative_soln, const dealii::Tensor<1,PHILIP_DIM,FadFadType> &normal_vector) const;
template RadFadType NavierStokes_ChannelFlowConstantSourceTerm_WallModel < PHILIP_DIM, PHILIP_DIM+2, RadFadType>::get_velocity_component_parallel_to_wall_from_solution_and_normal_vector(const std::array<RadFadType,PHILIP_DIM+2> &conservative_soln, const dealii::Tensor<1,PHILIP_DIM,RadFadType> &normal_vector) const;
