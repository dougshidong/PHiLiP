...
const unsigned int n_des_var_start = 30;//20;
const unsigned int n_des_var_end   = 30;//100;
...
::optimize (const unsigned int nx_ffd, const unsigned int poly_degree) const
{
    ...
    auto lift_con = ROL::makePtr<ROL::Constraint_SimOpt_from_Objective_SimOpt<double>> (lift_obj, lift_target);
    ...
    parlist.sublist("Step").sublist("Line Search").set("Initial Step Size",3e-1);
