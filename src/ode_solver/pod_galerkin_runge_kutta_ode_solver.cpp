...
template <int dim, typename real, int n_rk_stages, typename MeshType>
void PODGalerkingRungeKuttaODESolver<dim,real,n_rk_stages,MeshType>::calculate_stages(int i, real dt, const bool /*pseudotime*/)
{
    this->rk_stage[i] = 0.0;
...
template <int dim, typename real, int n_rk_stages, typename MeshType>
void PODGalerkingRungeKuttaODESolver<dim,real,n_rk_stages,MeshType>::obtain_stage(int i, real dt)
{
...
template <int dim, typename real, int n_rk_stages, typename MeshType>
void PODGalerkingRungeKuttaODESolver<dim,real,n_rk_stages,MeshType>::sum_stages(real dt, const bool /*pseudotime*/) 
{
...
template <int dim, typename real, int n_rk_stages, typename MeshType>
void PODGalerkingRungeKuttaODESolver<dim,real,n_rk_stages,MeshType>::apply_limiter() 
{
    // Empty Function
}
template <int dim, typename real, int n_rk_stages, typename MeshType>
...
template <int dim, typename real, int n_rk_stages, typename MeshType>
std::shared_ptr<Epetra_CrsMatrix> PODGalerkingRungeKuttaODESolver<dim,real,n_rk_stages,MeshType>::generate_test_basis(const Epetra_CrsMatrix &/*system_matrix*/, const Epetra_CrsMatrix &pod_basis)
{
...
template<int dim, typename real, int n_rk_stages, typename MeshType>
int PODGalerkingRungeKuttaODESolver<dim,real,n_rk_stages,MeshType>::multiply(Epetra_CrsMatrix &epetra_matrix,
...
template <int dim, typename real, int n_rk_stages, typename MeshType>
void PODGalerkingRungeKuttaODESolver<dim,real,n_rk_stages,MeshType>::epetra_to_dealii(Epetra_Vector &epetra_vector, 
...
template class PODGalerkingRungeKuttaODESolver<PHILIP_DIM, double,1, dealii::Triangulation<PHILIP_DIM> >;
template class PODGalerkingRungeKuttaODESolver<PHILIP_DIM, double,2, dealii::Triangulation<PHILIP_DIM> >;
template class PODGalerkingRungeKuttaODESolver<PHILIP_DIM, double,3, dealii::Triangulation<PHILIP_DIM> >;
template class PODGalerkingRungeKuttaODESolver<PHILIP_DIM, double,4, dealii::Triangulation<PHILIP_DIM> >;
template class PODGalerkingRungeKuttaODESolver<PHILIP_DIM, double,1, dealii::parallel::shared::Triangulation<PHILIP_DIM> >;
template class PODGalerkingRungeKuttaODESolver<PHILIP_DIM, double,2, dealii::parallel::shared::Triangulation<PHILIP_DIM> >;
template class PODGalerkingRungeKuttaODESolver<PHILIP_DIM, double,3, dealii::parallel::shared::Triangulation<PHILIP_DIM> >;
template class PODGalerkingRungeKuttaODESolver<PHILIP_DIM, double,4, dealii::parallel::shared::Triangulation<PHILIP_DIM> >;
#if PHILIP_DIM != 1
    template class PODGalerkingRungeKuttaODESolver<PHILIP_DIM, double,1, dealii::parallel::distributed::Triangulation<PHILIP_DIM> >;
    template class PODGalerkingRungeKuttaODESolver<PHILIP_DIM, double,2, dealii::parallel::distributed::Triangulation<PHILIP_DIM> >;
    template class PODGalerkingRungeKuttaODESolver<PHILIP_DIM, double,3, dealii::parallel::distributed::Triangulation<PHILIP_DIM> >;
    template class PODGalerkingRungeKuttaODESolver<PHILIP_DIM, double,4, dealii::parallel::distributed::Triangulation<PHILIP_DIM> >;
#endif
} // ODE namespace
} // PHiLiP namespace