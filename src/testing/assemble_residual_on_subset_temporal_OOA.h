#ifndef __ASSEMBLE_RESIDUAL_ON_SUBSET_TIME_REFINEMENT_STUDY__
#define __ASSEMBLE_RESIDUAL_ON_SUBSET_TIME_REFINEMENT_STUDY__
...
protected:
    ...
    /// Advances to end time while assembling on each subset individually.
    void advance_to_end_time(std::shared_ptr<FlowSolver::FlowSolver<dim,nstate>> flow_solver, const double end_time) const;
