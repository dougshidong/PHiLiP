...
private:
    ...
    void assemble_face_term_and_build_operators_ad(
        ...
        const unsigned int iface,
        const unsigned int neighbor_iface,
        const std::vector<double> &soln_int,
        const std::vector<double> &soln_ext,
        const std::vector<double> &metric_int,
        const std::vector<double> &metric_ext,
        const std::vector< double > &dual_int,
        const std::vector< double > &dual_ext,
        dealii::hp::FEFaceValues<dim,dim>  &fe_values_collection_face_int,
        dealii::hp::FEFaceValues<dim,dim>  &fe_values_collection_face_ext,
        ...
        const unsigned int neighbor_i_subface = 0) override
    {
    ...
    void assemble_face_term_and_build_operators_ad(
        ...
        const unsigned int iface,
        const unsigned int neighbor_iface,
        const std::vector<codi_JacobianComputationType> &soln_int,
        const std::vector<codi_JacobianComputationType> &soln_ext,
        const std::vector<codi_JacobianComputationType> &metric_int,
        const std::vector<codi_JacobianComputationType> &metric_ext,
        const std::vector< double > &dual_int,
        const std::vector< double > &dual_ext,
        dealii::hp::FEFaceValues<dim,dim>  &fe_values_collection_face_int,
        dealii::hp::FEFaceValues<dim,dim>  &fe_values_collection_face_ext,
    ...
    void assemble_face_term_and_build_operators_ad(
        ...
        const unsigned int iface,
        const unsigned int neighbor_iface,
        const std::vector<codi_HessianComputationType> &soln_int,
        const std::vector<codi_HessianComputationType> &soln_ext,
        const std::vector<codi_HessianComputationType> &metric_int,
        const std::vector<codi_HessianComputationType> &metric_ext,
        const std::vector< double > &dual_int,
        const std::vector< double > &dual_ext,
        dealii::hp::FEFaceValues<dim,dim>  &fe_values_collection_face_int,
        dealii::hp::FEFaceValues<dim,dim>  &fe_values_collection_face_ext,
