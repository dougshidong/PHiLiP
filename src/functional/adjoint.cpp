...
template class Adjoint <PHILIP_DIM, 6, double, dealii::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 7, double, dealii::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 8, double, dealii::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 9, double, dealii::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 10, double, dealii::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 11, double, dealii::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 12, double, dealii::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 13, double, dealii::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 14, double, dealii::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 15, double, dealii::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 5+11, double, dealii::Triangulation<PHILIP_DIM>>; // "maximum n_state" = "5+maximum_n_species"
...
template class Adjoint <PHILIP_DIM, 6, double, dealii::parallel::shared::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 7, double, dealii::parallel::shared::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 8, double, dealii::parallel::shared::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 9, double, dealii::parallel::shared::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 10, double, dealii::parallel::shared::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 11, double, dealii::parallel::shared::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 12, double, dealii::parallel::shared::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 13, double, dealii::parallel::shared::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 14, double, dealii::parallel::shared::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 15, double, dealii::parallel::shared::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 5+11, double, dealii::parallel::shared::Triangulation<PHILIP_DIM>>; // "maximum n_state" = "5+maximum_n_species"
...
template class Adjoint <PHILIP_DIM, 6, double, dealii::parallel::distributed::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 7, double, dealii::parallel::distributed::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 8, double, dealii::parallel::distributed::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 9, double, dealii::parallel::distributed::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 10, double, dealii::parallel::distributed::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 11, double, dealii::parallel::distributed::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 12, double, dealii::parallel::distributed::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 13, double, dealii::parallel::distributed::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 14, double, dealii::parallel::distributed::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 15, double, dealii::parallel::distributed::Triangulation<PHILIP_DIM>>;
template class Adjoint <PHILIP_DIM, 5+11, double, dealii::parallel::distributed::Triangulation<PHILIP_DIM>>; // "maximum n_state" = "5+maximum_n_species"
#endif
