...
namespace PHiLiP
{
    ...
    std::array<Tensor<1,dim,real>,nstate> array_jump(
    ...
    //    const std::vector<Tensor<1,dim,real>> &normal_int,
    ...
    //    const std::array<Tensor<1,dim,real>, nstate> &soln_grad_int) const
    //{
    //}
