    ...
    Parameters::AllParameters const *const param)
{
    ...
    } else if (flow_type == FlowCaseEnum::naca0012  || flow_type == FlowCaseEnum::gaussian_bump || flow_type == FlowCaseEnum::airfoil_2D || flow_type == FlowCaseEnum::naca0012_turbulence) {
