...
#SBATCH --mail-user=julien.brillon@mail.mcgill.ca # uncomment to send an email whe job starts/end
...
#mpirun -n 2 "/home/brillon/scratch/PHiLiP_3D" -i "/home/brillon/projects/rrg-nadaraja-ac/brillon/PHiLiP//tests/integration_tests_control_files/euler_split_inviscid_taylor_green_vortex/3D_euler_split_inviscid_taylor_green_vortex.prm"
