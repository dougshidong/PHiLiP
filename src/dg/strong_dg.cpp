...
#if N_SPECIES>1
template class DGStrong <PHILIP_DIM, (PHILIP_DIM+2)+(N_SPECIES-1),double, dealii::Triangulation<PHILIP_DIM>>;
#else
...
#if N_SPECIES>1
template class DGStrong <PHILIP_DIM, (PHILIP_DIM+2)+(N_SPECIES-1),double, dealii::parallel::shared::Triangulation<PHILIP_DIM>>;
#else
...
#if PHILIP_DIM!=1
#if N_SPECIES>1
template class DGStrong <PHILIP_DIM, (PHILIP_DIM+2)+(N_SPECIES-1),double, dealii::parallel::distributed::Triangulation<PHILIP_DIM>>;  
#else
