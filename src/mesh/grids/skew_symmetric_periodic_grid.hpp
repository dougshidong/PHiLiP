...
/// Create a skew-symmetric grid with an associated nonlinear manifold.
/** The mapping for the 2D grid follows from
 *  Hennemann, Sebastian, et al. "A provably entropy stable subcell shock capturing
 *  approach for high order split form DG for the compressible Euler equations."
 *  Journal of Computational Physics 426 (2021): 109935. Eq.(59).
*/
