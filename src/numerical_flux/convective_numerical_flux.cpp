...
template <int dim, int nstate, typename real>
std::array<real, nstate> CentralNumericalFlux<dim,nstate,real>::evaluate_flux(
 const std::array<real, nstate> &soln_int,
    const std::array<real, nstate> &soln_ext,
    const dealii::Tensor<1,dim,real> &normal_int) const
{
...
template <int dim, int nstate, typename real>
std::array<real, nstate> EntropyConservingNumericalFlux<dim,nstate,real>::evaluate_flux(
 const std::array<real, nstate> &soln_int,
    const std::array<real, nstate> &soln_ext,
    const dealii::Tensor<1,dim,real> &normal_int) const
{
...
template <int dim, int nstate, typename real>
std::array<real, nstate> SplitFormNumericalFlux<dim,nstate,real>::evaluate_flux(
    const std::array<real, nstate> &soln_int,
    const std::array<real, nstate> &soln_ext,
    const dealii::Tensor<1,dim,real> &normal_int) const
{
...
template class CentralNumericalFlux<PHILIP_DIM, 1, double>;
template class CentralNumericalFlux<PHILIP_DIM, 2, double>;
template class CentralNumericalFlux<PHILIP_DIM, 3, double>;
template class CentralNumericalFlux<PHILIP_DIM, 4, double>;
template class CentralNumericalFlux<PHILIP_DIM, 5, double>;
template class CentralNumericalFlux<PHILIP_DIM, 1, FadType >;
template class CentralNumericalFlux<PHILIP_DIM, 2, FadType >;
template class CentralNumericalFlux<PHILIP_DIM, 3, FadType >;
template class CentralNumericalFlux<PHILIP_DIM, 4, FadType >;
template class CentralNumericalFlux<PHILIP_DIM, 5, FadType >;
template class CentralNumericalFlux<PHILIP_DIM, 1, RadType >;
template class CentralNumericalFlux<PHILIP_DIM, 2, RadType >;
template class CentralNumericalFlux<PHILIP_DIM, 3, RadType >;
template class CentralNumericalFlux<PHILIP_DIM, 4, RadType >;
template class CentralNumericalFlux<PHILIP_DIM, 5, RadType >;
template class CentralNumericalFlux<PHILIP_DIM, 1, FadFadType >;
template class CentralNumericalFlux<PHILIP_DIM, 2, FadFadType >;
template class CentralNumericalFlux<PHILIP_DIM, 3, FadFadType >;
template class CentralNumericalFlux<PHILIP_DIM, 4, FadFadType >;
template class CentralNumericalFlux<PHILIP_DIM, 5, FadFadType >;
template class CentralNumericalFlux<PHILIP_DIM, 1, RadFadType >;
template class CentralNumericalFlux<PHILIP_DIM, 2, RadFadType >;
template class CentralNumericalFlux<PHILIP_DIM, 3, RadFadType >;
template class CentralNumericalFlux<PHILIP_DIM, 4, RadFadType >;
template class CentralNumericalFlux<PHILIP_DIM, 5, RadFadType >;

template class EntropyConservingNumericalFlux<PHILIP_DIM, 1, double>;
template class EntropyConservingNumericalFlux<PHILIP_DIM, 2, double>;
template class EntropyConservingNumericalFlux<PHILIP_DIM, 3, double>;
template class EntropyConservingNumericalFlux<PHILIP_DIM, 4, double>;
template class EntropyConservingNumericalFlux<PHILIP_DIM, 5, double>;
template class EntropyConservingNumericalFlux<PHILIP_DIM, 1, FadType >;
template class EntropyConservingNumericalFlux<PHILIP_DIM, 2, FadType >;
template class EntropyConservingNumericalFlux<PHILIP_DIM, 3, FadType >;
template class EntropyConservingNumericalFlux<PHILIP_DIM, 4, FadType >;
template class EntropyConservingNumericalFlux<PHILIP_DIM, 5, FadType >;
template class EntropyConservingNumericalFlux<PHILIP_DIM, 1, RadType >;
template class EntropyConservingNumericalFlux<PHILIP_DIM, 2, RadType >;
template class EntropyConservingNumericalFlux<PHILIP_DIM, 3, RadType >;
template class EntropyConservingNumericalFlux<PHILIP_DIM, 4, RadType >;
template class EntropyConservingNumericalFlux<PHILIP_DIM, 5, RadType >;
template class EntropyConservingNumericalFlux<PHILIP_DIM, 1, FadFadType >;
template class EntropyConservingNumericalFlux<PHILIP_DIM, 2, FadFadType >;
template class EntropyConservingNumericalFlux<PHILIP_DIM, 3, FadFadType >;
template class EntropyConservingNumericalFlux<PHILIP_DIM, 4, FadFadType >;
template class EntropyConservingNumericalFlux<PHILIP_DIM, 5, FadFadType >;
template class EntropyConservingNumericalFlux<PHILIP_DIM, 1, RadFadType >;
template class EntropyConservingNumericalFlux<PHILIP_DIM, 2, RadFadType >;
template class EntropyConservingNumericalFlux<PHILIP_DIM, 3, RadFadType >;
template class EntropyConservingNumericalFlux<PHILIP_DIM, 4, RadFadType >;
template class EntropyConservingNumericalFlux<PHILIP_DIM, 5, RadFadType >;

template class SplitFormNumericalFlux<PHILIP_DIM, 1, double>;
template class SplitFormNumericalFlux<PHILIP_DIM, 2, double>;
template class SplitFormNumericalFlux<PHILIP_DIM, 3, double>;
template class SplitFormNumericalFlux<PHILIP_DIM, 4, double>;
template class SplitFormNumericalFlux<PHILIP_DIM, 5, double>;
template class SplitFormNumericalFlux<PHILIP_DIM, 1, FadType >;
template class SplitFormNumericalFlux<PHILIP_DIM, 2, FadType >;
template class SplitFormNumericalFlux<PHILIP_DIM, 3, FadType >;
template class SplitFormNumericalFlux<PHILIP_DIM, 4, FadType >;
template class SplitFormNumericalFlux<PHILIP_DIM, 5, FadType >;
template class SplitFormNumericalFlux<PHILIP_DIM, 1, RadType >;
template class SplitFormNumericalFlux<PHILIP_DIM, 2, RadType >;
template class SplitFormNumericalFlux<PHILIP_DIM, 3, RadType >;
template class SplitFormNumericalFlux<PHILIP_DIM, 4, RadType >;
template class SplitFormNumericalFlux<PHILIP_DIM, 5, RadType >;
template class SplitFormNumericalFlux<PHILIP_DIM, 1, FadFadType >;
template class SplitFormNumericalFlux<PHILIP_DIM, 2, FadFadType >;
template class SplitFormNumericalFlux<PHILIP_DIM, 3, FadFadType >;
template class SplitFormNumericalFlux<PHILIP_DIM, 4, FadFadType >;
template class SplitFormNumericalFlux<PHILIP_DIM, 5, FadFadType >;
template class SplitFormNumericalFlux<PHILIP_DIM, 1, RadFadType >;
template class SplitFormNumericalFlux<PHILIP_DIM, 2, RadFadType >;
template class SplitFormNumericalFlux<PHILIP_DIM, 3, RadFadType >;
template class SplitFormNumericalFlux<PHILIP_DIM, 4, RadFadType >;
template class SplitFormNumericalFlux<PHILIP_DIM, 5, RadFadType >;
