...
int main(int /*argc*/, char ** /*argv*/)
{
  ...
  Sacado::Rad::ADvar< Sacado::Fad::DFad<double> >::Outvar_Gradcomp(rrad);
  ...
  Sacado::Fad::DFad<double> a1_temp(num_deriv, 0, a);
  // Fad objects
  Sacado::Rad::ADvar< Sacado::Fad::DFad<double> > a1rad;
  a1rad = a_temp;
  // a1rad = a;
  // a1rad.adj().val() = 1.0;
  // a1rad.val().diff(0,1);
  // a1rad.adj().diff(0,1);
  Sacado::Rad::ADvar< Sacado::Fad::DFad<double> > r1rad;
  ...
  // Extract value and derivatives
  r_ad = r1rad.val().val();       // r
  drda_ad = a1rad.adj().val();    // dr/da
  d2rda2_ad = a1rad.adj().dx(0);  // d^2r/da^2
  //Sacado::Rad::ADvar< Sacado::Fad::DFad<double> >:: aval_reset ();
  //Sacado::Rad::ADcontext< Sacado::Fad::DFad<double> >:: re_init();
