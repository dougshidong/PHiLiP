#ifndef __PHILIP_SQP_H__
#define __PHILIP_SQP_H__
 ...
 */
template <class Real>
class SequentialQuadraticProgrammingStep : public Step<Real> {
private:
    ...
    ROL::Ptr<Vector<Real>> previous_lagrangian_gradient_;

    /// Secant object (used for quasi-Newton preconditioner).
    ROL::Ptr<Secant<Real> > secant_;

    /// Secant object used to estimate Lagrangian Hessian.
    ROL::Ptr<Secant<Real> > lagrange_hessian_approx_;
...
public:
    ...
    /** \brief Constructor.
        ...
        Standard constructor to build a SequentialQuadraticProgrammingStep object.
...
}; // class SequentialQuadraticProgrammingStep
