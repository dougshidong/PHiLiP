...
protected:
    ...
    /// Setter for butcher_tableau_a1
    void set_a3() override;

    /// Setter for butcher_tableau_a2
    void set_a4() override;

    /// Setter for butcher_tableau_a2
    void set_a5() override;

    /// Setter for butcher_tableau_a2
    void set_a6() override;

    /// Setter for butcher_tableau_a3
    //void set_a10() override;
...
template <int dim, typename real, typename MeshType = dealii::parallel::distributed::Triangulation<dim>>
#endif
class PERK_3_16_3: public PERKTableauBase <dim, real, MeshType>
{
public:
    /// Constructor
    PERK_3_16_3(const int n_rk_stages, const std::string rk_method_string_input) 
        : PERKTableauBase<dim,real,MeshType>(n_rk_stages, rk_method_string_input) { }
