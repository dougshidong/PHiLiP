...
template<int dim, int nspecies, int nstate>
std::unique_ptr<ProperOrthogonalDecomposition::ROMSolution<dim,nstate>> HyperreducedAdaptiveSampling<dim, nspecies, nstate>::solveSnapshotROM(const RowVectorXd& parameter, Epetra_Vector weights) const{
