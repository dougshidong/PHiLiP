...
::LiftDragFunctional(
    ...
    , euler_fad_fad(dynamic_cast< Physics::Euler<dim,nspecies,dim+2,FadFadType> &>(*(this->physics_fad_fad)))
...
template <int dim, int nspecies, int nstate,typename real,typename MeshType>
double LiftDragFunctional<dim,nspecies,nstate,real,MeshType>
...
template <int dim, int nspecies, int nstate,typename real,typename MeshType>
dealii::Tensor<2,dim,double> LiftDragFunctional<dim,nspecies,nstate,real,MeshType>
...
template <int dim, int nspecies, int nstate,typename real,typename MeshType>
dealii::Tensor<1,dim,double> LiftDragFunctional<dim,nspecies,nstate,real,MeshType>
...
template <int dim, int nspecies, int nstate,typename real,typename MeshType>
real LiftDragFunctional<dim,nspecies,nstate,real,MeshType>
