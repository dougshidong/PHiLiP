...
template <int dim, int nstate, typename real>
class InitialConditionFunction_MultiSpecies_VortexAdvection: public InitialConditionFunction<dim,nstate,real>
{
protected:
    using dealii::Function<dim,real>::value; ///< dealii::Function we are templating on
...
template <int dim, int nstate, typename real>
class InitialConditionFunction_MultiSpecies_HighTemperature_VortexAdvection: public InitialConditionFunction<dim,nstate,real>
{
protected:
    using dealii::Function<dim,real>::value; ///< dealii::Function we are templating on
...
template <int dim, int nstate, typename real>
class InitialConditionFunction_Euler_VortexAdvection : public InitialConditionFunction<dim,nstate,real>
{
protected:
    using dealii::Function<dim,real>::value; ///< dealii::Function we are templating on
...
template <int dim, int nstate, typename real>
class InitialConditionFunction_MultiSpecies_CaloricallyPerfect_Euler_VortexAdvection: public InitialConditionFunction<dim,nstate,real>
{
protected:
    using dealii::Function<dim,real>::value; ///< dealii::Function we are templating on
...
template <int dim, int nstate, typename real>
class InitialConditionFunction_MultiSpecies_IsentropicEulerVortex : public InitialConditionFunction<dim,nstate,real>
{
protected:
    using dealii::Function<dim,real>::value; ///< dealii::Function we are templating on
...
/// 2D Initial Condition Function: MultiSpecies_TwoDimnsional_VortexAdvection 
template <int dim, int nstate, typename real>
class InitialConditionFunction_MultiSpecies_TwoDimnsional_VortexAdvection: public InitialConditionFunction<dim,nstate,real>
{
protected:
    using dealii::Function<dim,real>::value; ///< dealii::Function we are templating on
...
public:
     ...
     *  These initial conditions are given in nondimensional form (free-stream as reference)
     */
    InitialConditionFunction_MultiSpecies_TwoDimnsional_VortexAdvection (
            Parameters::AllParameters const *const param);
...
template <int dim, int nstate, typename real>
class InitialConditionFunction_MultiSpecies_FuelDropAdvection: public InitialConditionFunction<dim,nstate,real>
{
protected:
    using dealii::Function<dim,real>::value; ///< dealii::Function we are templating on
...
/// 3D Initial Condition Function: MultiSpecies_ThreeDimnsional_VortexAdvection 
template <int dim, int nstate, typename real>
class InitialConditionFunction_MultiSpecies_ThreeDimnsional_VortexAdvection: public InitialConditionFunction<dim,nstate,real>
{
protected:
    using dealii::Function<dim,real>::value; ///< dealii::Function we are templating on
...
public:
     ...
     *  These initial conditions are given in nondimensional form (free-stream as reference)
     */
    InitialConditionFunction_MultiSpecies_ThreeDimnsional_VortexAdvection (
            Parameters::AllParameters const *const param);
...
template <int dim, int nstate, typename real>
class InitialConditionFunction_MultiSpecies_TaylorGreenVortex: public InitialConditionFunction<dim,nstate,real>
{
protected:
    using dealii::Function<dim,real>::value; ///< dealii::Function we are templating on
...
template <int dim, int nstate, typename real>
class InitialConditionFunction_MultiSpecies_Mixture_TaylorGreenVortex: public InitialConditionFunction<dim,nstate,real>
{
protected:
    using dealii::Function<dim,real>::value; ///< dealii::Function we are templating on
