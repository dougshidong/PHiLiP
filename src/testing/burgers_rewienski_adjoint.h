#ifndef __BURGERS_REWIENSKI_ADJOINT_H__
#define __BURGERS_REWIENSKI_ADJOINT_H__
...
/// Burgers Rewienski adjoint
template <int dim, int nstate>
class BurgersRewienskiAdjoint: public TestsBase
{
public:
    /// Constructor.
    BurgersRewienskiAdjoint(const Parameters::AllParameters *const parameters_input);
