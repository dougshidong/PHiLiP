...
int ReducedOrder<dim, nstate>::run_test() const
{
    ...
    pcout << "dg pod-petrov-galerkin created" <<std::endl;
    ...
    while (current_iteration < number_of_time_steps)
    {
        ...
        pcout << "galerkin: " << pod_galerkin_solution.l2_norm() << " full order " << implicit_solution.l2_norm();
    ...
    if (pod_galerkin_error < 0.02 && pod_petrov_galerkin_error < 0.02){
        pcout << "Passed!";
        return 0;
    }else{
        pcout << "Failed!";
